...
const styles = {
  ...
  p: { margin: '10px 0', color: '#888', fontSize: '14px' },
  actionCard: { backgroundColor: '#0a0a0a', padding: '25px', borderRadius: '12px', border: '1px dotted #222' },
  inputGroup: { display: 'flex', gap: '15px', marginTop: '15px' },
  input: { backgroundColor: '#000', border: '1px solid #222', padding: '12px', borderRadius: '6px', color: '#fff', flex: 1 },
